...
const Socios = () => {
  return (
    <div className=' justify-around items-center flex min-h-screen bg-fixed bg-center bg-cover custom-img'>
            ...
            <div className='laptop:flex-grow laptop:w-[60%] mobile:mx-6 bg-white shadow-2xl shadow-black rounded-xl pb-8 h-fit my-10 desktop:mx-0 self-start '>
                <div className="items-center">
                    ...
                    <div className='mx-16 text-justify mb-6 mobile:text-lg tablet:text-base'>
                    ...
                    <div className='mx-10 text-justify mb-6 mobile:text-lg tablet:text-base'>Una persona puede solicitar su inscripción como socio del club en cualquier momento del año, si bien con algún matiz: las inscripciones realizadas a tal efecto a partir del <b>1 de octubre</b>, se considerarán válidas hasta el <b>31 de diciembre</b> del año siguiente. </div>
                    
                    <hr className=' border-2 border-color-atlas-300 mx-10 mb-6' />

                    <div className='mx-10 text-center mb-6 mobile:text-lg tablet:text-base'>Para la temporada 2023, los socios que se inscriban al club recibirán una <b>camiseta de entrenamiento</b>, además de un <b>pequeño obsequio</b>.</div>
